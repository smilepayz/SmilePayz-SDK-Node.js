...
async function inquiryBalance(merchantId, merchantCode, baseDomain) {
    ...
    const minify = JSON.stringify(inquiryBalanceReq);
...
inquiryBalance(sandboxMerchanteId, sandboxMerchanteCode, sandboxBaseDomain);
