...
async function payoutRequest(merchantId,merchantCode,domain){
    ...
    const signData = referenceId +"|" + timestamp + '|' +  merchantCode + '|' + minify;
...
payoutRequest(merchanteId,merchanteCode,baseDomain);
